...
export const config = {
   ...
   * сообщения. Поэтому пределов три, и каждый закрывает свой случай.
   *
   ...
   */
  storage: {
    /** Всё, что человек загрузил за всё время. */
    perUserBytes: 100 * 1024 * 1024, // 100 МБ
    /** За последние сутки — чтобы место нельзя было занять за один вечер. */
